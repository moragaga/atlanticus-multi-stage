# Genera IDs internos estables para componentes y para el polling agregado; el desarrollador no construye estos IDs.
...
@dataclass(frozen=True, slots=True)
# Los IDs de revisión pertenecen al canal agregado, nunca a componentes individuales.
