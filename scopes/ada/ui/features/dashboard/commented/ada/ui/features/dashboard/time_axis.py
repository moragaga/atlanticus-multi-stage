# Construcción centralizada del eje temporal para evitar repetir lógica en cada renderer.
# El eje matemático se genera siempre en UTC sobre [start_utc, end_utc).
# La conversión local usa ZoneInfo y solo agrega el offset al label cuando la hora local se repite.
# Esto conserva correctamente transiciones DST como -03:00/-04:00 en America/Santiago.
