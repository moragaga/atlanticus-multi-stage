# Espejo pedagógico del contrato de scheduling visual.
# Las estrategias son semánticas y no contienen coordenadas del navegador.
...
# IO usa queue-in-queue; Process usa cola normal y opcionalmente una cola distribuida.
class AlarmVisibilityStrategy(StrEnum):
    QUEUE_IN_QUEUE = 'queue-in-queue'
    PROCESS = 'process'


# Los tiempos se declaran desde composición/harness y siguen desacoplados entre sí.
...
# Cada lane de IO posee su propio intervalo independiente.
