...
# Este tono describe solo la presentación del resumen consolidado del Header.
...
@dataclass(frozen=True, slots=True)
# El resumen consolidado es distinto del flujo de gestionar una alarma individual.
