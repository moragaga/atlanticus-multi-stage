"""Contratos inmutables para variantes y reglas de activación de marca."""
...
class BrandActivationRule(Protocol):
    """Regla intercambiable; permite sumar Pascua u otras reglas sin tocar el resolver."""
...
class MonthDayWindow:
    ...
    def is_active(self, current_date: date) -> bool:
        ...
        # Si el inicio es posterior al fin, la ventana cruza el cambio de año.
...
def _validate_month_day(month: int, day: int, *, field_name: str) -> None:
    try:
        # Año bisiesto para aceptar contratos que eventualmente incluyan 29 de febrero.
        date(2000, month, day)
