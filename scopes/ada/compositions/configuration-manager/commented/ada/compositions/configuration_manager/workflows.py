# Adapta cada configuración al lifecycle genérico del Manager Atlanticus.
# El código bajo estos comentarios conserva paridad ejecutable con producción.
from __future__ import annotations

from ada.configuration.kpis import KpiConfiguration, KpiConfigurationServices
...
class KpiManagerWorkflowAdapter:
