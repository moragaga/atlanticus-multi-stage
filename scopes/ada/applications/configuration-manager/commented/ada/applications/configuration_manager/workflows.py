# Adapta workflows de dominio al contrato genérico del Configuration Manager.
...
# ToolManagerWorkflowAdapter: mantiene esta responsabilidad aislada y verificable.
...
# UsersManagerWorkflowAdapter: mantiene esta responsabilidad aislada y verificable.
...
# _status: mantiene esta operación aislada y verificable.
...
# _validation: mantiene esta operación aislada y verificable.
...
# _publication: mantiene esta operación aislada y verificable.
...
# _projection: mantiene esta operación aislada y verificable.
...
# _optional_audit: mantiene esta operación aislada y verificable.
def _optional_audit(record) -> ProjectionAuditRecord | None:
    return _audit(record) if record is not None else None


# _audit: mantiene esta operación aislada y verificable.
...
# _issue: mantiene esta operación aislada y verificable.
...
# _summary: mantiene esta operación aislada y verificable.
