# Espejo pedagógico del harness visual de Alarmas.
# Los tiempos cortos son solo de QA visual y no representan la política productiva de 2–3 minutos.
# No agrega callbacks ni backend: todo el comportamiento de este incremento se prueba clientside.
...
# IO: queue-in-queue con reloj independiente por posición ocupada.
...
# Process normal: 8 eventos, 6 slots y avance temporal serializado.
...
# Process distribuido: slot 6 reservado solo con >=2 distribuidas y reloj propio.
...
# Singleton global: la única alarma conserva su traza y el click no modifica el estado.
