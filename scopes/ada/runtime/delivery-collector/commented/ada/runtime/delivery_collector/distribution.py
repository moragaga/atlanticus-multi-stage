# Distribución pura de snapshots Latest/Timeseries hacia los stores definidos por Tools.
...
# Plan inmutable: None significa que ese output debe conservarse con no_update.
...
# Usa revision para detectar snapshot nuevo y luego compara contenido por componente.
...
# Extrae cada destination Latest sin normalizar status, value_kind ni value.
...
# Agrupa ventanas Timeseries usando destination explícito del contrato.
...
# Evita duplicados y evita retroceder si la petición cae en un worker atrasado.
