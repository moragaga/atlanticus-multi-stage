# Materialización de los stores de control de sesión y reutilización de los stores R3.
...
# IDs internos de control derivados de la key estable de la Tool.
...
@dataclass(frozen=True, slots=True)
# Host oculto que contiene controles de sesión y todos los stores R3.
...
# Construye el runtime reactivo sin registrar todavía presentación alguna.
