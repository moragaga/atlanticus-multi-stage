# Adaptador Dash que coordina señal, lock y Collector sin acceder directamente a Cosmos.
...
# Registra exactamente tres callbacks: solicitud, adquisición de lock y Collector.
def register_runtime_delivery_collector_callbacks(
    ...
    *,
    ...
    # El intervalo sólo emite señal cuando la sesión no tiene una ejecución vigente.
    ...
    # La primera señal válida adquiere autoridad de ejecución en la sesión.
    ...
    # Un único callback obtiene ambos canales desde el cache compartido del proceso.
...
# Un fallo en un canal no invalida la entrega last-known-good del otro canal.
