# La Projection publica el ToolManifest junto con los bindings runtime derivados.
# Schema 3 persiste bindings; schema 2 continúa leyéndose y deriva los bindings para migración sin corte.
