# Contrato derivado de bindings runtime para componentes y subcomponentes de Tool.
# Los IDs no son configurables: se calculan desde las keys estables y luego la proyección los certifica.
# Cada componente reserva wrapper y stores KPI Latest/Timeseries; los subcomponentes reservan su wrapper para composición y alarmas.
