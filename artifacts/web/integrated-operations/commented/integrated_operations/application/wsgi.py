...
RuntimeFactory = Callable[[], IntegratedOperationsApplicationRuntime]
...
class WorkerApplication:
    def __init__(self, factory: RuntimeFactory = create_application_runtime) -> None:
        ...
        self._lock = Lock()
        self._runtime: IntegratedOperationsApplicationRuntime | None = None
    ...
    def __call__(self, environ: dict[str, Any], start_response: Callable[..., Any]):
        ...
        if runtime is None:
            raise RuntimeError('Integrated Operations worker runtime is not initialized')
