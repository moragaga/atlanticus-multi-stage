...
# Resuelve la surface operacional por registry y recibe el Manager ya compuesto.
...
# El host sólo agrega los módulos declarados por cada composición; no conoce sus detalles internos.
