# Espejo comentado: el consumidor aporta proyecciones y renderers, no infraestructura ADA.
...
def _render_component(bundle: ComponentBundle, *, component_key: str):
    ...
    return {
        subcomponent: _render_card(bundle, subcomponent=subcomponent, value=values.get(subcomponent))
