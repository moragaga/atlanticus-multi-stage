...
CRITICAL_PATH_PINNED_WHEELS = {
    'ada-composition-configuration-manager': (
        '0.1.26',
        'ada_composition_configuration_manager-0.1.26-py3-none-any.whl',
    ),
    'ada-composition-manager-surface': (
        '0.1.2',
    ...
    'ada-composition-web-bootstrap': (
        '0.1.15',
        'ada_composition_web_bootstrap-0.1.15-py3-none-any.whl',
    ),
    'ada-composition-web-deployment': (
        '0.1.17',
        'ada_composition_web_deployment-0.1.17-py3-none-any.whl',
    ),
    'ada-configuration-kpis': (
        '0.2.8',
        'ada_configuration_kpis-0.2.8-py3-none-any.whl',
    ),
    'ada-configuration-tools': (
        '0.1.13',
        'ada_configuration_tools-0.1.13-py3-none-any.whl',
    ),
    'atlanticus-web-composition-runtime-infrastructure': (
        '0.1.1',
    ...
    'atlanticus-web-users-cosmos': (
        '0.1.6',
        'atlanticus_web_users_cosmos-0.1.6-py3-none-any.whl',
    ),
    'atlanticus-web-users-local': (
        '0.1.0',
...
CRITICAL_TRANSITIVE_WHEELS = {
    ...
    'atlanticus-web-navigation-configuration': (
        '0.1.5',
        'atlanticus_web_navigation_configuration-0.1.5-py3-none-any.whl',
    ),
    'atlanticus-web-users-configuration': (
        '0.1.6',
        'atlanticus_web_users_configuration-0.1.6-py3-none-any.whl',
    ),
}
