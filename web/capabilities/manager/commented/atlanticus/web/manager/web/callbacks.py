...
# El ownership del workspace siempre se resuelve contra el principal actual. Un documento
# persistido de otra identidad o inválido no debe bloquear la hidratación desde Source ni
# convertir el editor de fallback en trabajo local del usuario actual.
