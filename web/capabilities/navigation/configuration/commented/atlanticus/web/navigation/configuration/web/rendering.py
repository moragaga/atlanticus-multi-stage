# Renderiza la estructura editable de Navigation desde un contrato compartido por layout y callbacks.
# Mantener este render fuera de callbacks evita duplicación y permite mostrar el workspace vacío desde el primer montaje.
