# Espejo pedagógico: el resolver filtra navegación usando solo NavigationPrincipal.
# unrestricted concede acceso total; el resto compara access_key con allowed_profiles.
