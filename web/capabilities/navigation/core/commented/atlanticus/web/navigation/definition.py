...
# Proveedor que desacopla el consumidor de Navigation del origen concreto de su definición.
class NavigationDefinitionProvider:
    ...
    # Comparte una única definición durante el request para evitar lecturas repetidas
    # de la proyección.
...
# Fuera de un request no se cachea, permitiendo validaciones y pruebas sobre cambios sucesivos.
