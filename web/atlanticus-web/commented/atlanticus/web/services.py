# Registro explícito de dependencias compartidas. Se congela antes de montar consumidores para evitar mutaciones tardías.
...
class ServiceRegistry:
    ...
    # El freeze convierte la etapa de registro en un contrato cerrado antes del runtime.
