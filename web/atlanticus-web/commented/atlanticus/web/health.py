# Health separa liveness de readiness y nunca expone mensajes privados de excepciones.
...
class HealthRegistry:
    ...
    def evaluate(self) -> HealthReport:
        ...
        for check in self._checks.values():
            ...
            # La readiness comunica el tipo de fallo, pero evita filtrar el mensaje interno.
