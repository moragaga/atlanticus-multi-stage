# Construye index_string de forma composable y serializa solo configuración pública apta para el navegador.
...
def render_index_string(
    *,
    ...
    # Solo esta configuración se publica en el HTML; secretos y configuración interna no pertenecen al index.
    runtime_config = {
        'application': {
            'id': application_id,
            'name': display_name,
