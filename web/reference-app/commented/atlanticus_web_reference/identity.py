# La aplicación de referencia selecciona explícitamente el provider compuesto.
# Esta selección pertenece a la composición de la aplicación, no al core de Identity.
...
def build_reference_identity_provider() -> IdentityProvider:
    ...
    raise IdentityConfigurationError(
        f'Unsupported identity provider for reference application: {provider_key!r}'
    )
