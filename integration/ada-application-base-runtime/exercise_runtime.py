...
from ada_application_base.definition import build_deployment_definition, build_metadata
...
_EMAIL = 'atlanticus.r18b@example.com'
_DISPLAY_NAME = 'Atlanticus R18B Operator'
_CLIENT_SESSION_ID = 'r18b-runtime-smoke'
...
def main() -> None:
    ...
    print('Lazy runtime first HTTP request: OK')
    print('App Service identity + home: OK')
    print('Production asset snapshot: OK')
    print('User activity HTTP + Cosmos persistence: OK')
    print('R18B ADA Application Base runtime smoke passed.')
